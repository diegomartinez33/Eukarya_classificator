...
def train_model(type_crossval="k-fold", type_classif="qda"):
	...
	if type_classif == 'qda':
		...
		kwargs = {"n_trees" : 10, "boots" : False, "fs_type" : fs_type}
		...
		bool_cnn = True
		kwargs = {"Net_type" : 'mnist_net_dropout', "gpu" : True, "fs_type" : fs_type}
	else:
...
if __name__ == '__main__':
	train_model(type_crossval="k-fold", type_classif="cnn")
