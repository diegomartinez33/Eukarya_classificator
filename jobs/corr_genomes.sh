...
#SBATCH --job-name=stickleback_subs	#Nombre del job
#SBATCH -p gpu
...
#SBATCH --mail-user=diegand96@gmail.com
#SBATCH --mail-type=ALL			
#SBATCH -o stickleback_subs.o%j		#Nombre de archivo de salida
